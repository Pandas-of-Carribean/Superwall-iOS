...
public extension SuperwallDelegate {
    func subscriptionStatusDidChange(
        from _: SubscriptionStatus,
        to _: SubscriptionStatus
    ) {}

    func handleCustomPaywallAction(withName _: String) {}

    func willDismissPaywall(withInfo _: PaywallInfo) {}

    func willPresentPaywall(withInfo _: PaywallInfo) {}

    func didDismissPaywall(withInfo _: PaywallInfo) {}

    func didPresentPaywall(withInfo _: PaywallInfo) {}

    func paywallWillOpenURL(url _: URL) {}

    func paywallWillOpenDeepLink(url _: URL) {}

    func handleSuperwallEvent(withInfo _: SuperwallEventInfo) {}

    @available(*, deprecated, renamed: "handleSuperwallEvent(withInfo:)")
    func handleSuperwallPlacement(withInfo _: SuperwallPlacementInfo) {}
    ...
    func didRedeemLink(result _: RedemptionResult) {}

    func willRedeemLink() {}

    func handleSuperwallDeepLink(
        _: URL,
        pathComponents _: [String],
