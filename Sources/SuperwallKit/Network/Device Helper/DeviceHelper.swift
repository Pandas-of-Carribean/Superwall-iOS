...
class DeviceHelper {
    ...
    init(
        ...
        appInstalledAtString = appInstallDate?.isoString ?? ""
        self.receiptManager = receiptManager
        self.factory = factory
        reachability = SCNetworkReachabilityCreateWithName(kCFAllocatorDefault, api.base.host)
        sdkVersionPadded = Self.makePaddedVersion(using: sdkVersion)
        appVersionPadded = Self.makePaddedVersion(using: appVersion)
    }
