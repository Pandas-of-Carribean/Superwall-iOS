...
public enum RedemptionResult: Codable {
    ...
    public var stripeSubscriptionIds: [String]? {
        ...
        case let .success(_, info):
            ...
            case let .stripe(_, subscriptionIds):
    ...
    public struct ErrorInfo: Codable {
        ...
        func toObjc() -> RedemptionResultObjc.ErrorInfo {
            return RedemptionResultObjc.ErrorInfo(message: message)
        }
    }
    ...
    public struct RedemptionInfo: Codable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            purchaserInfo = try container.decode(PurchaserInfo.self, forKey: .purchaserInfo)
            paywallInfo = try container.decodeIfPresent(PaywallInfo.self, forKey: .paywallInfo)
