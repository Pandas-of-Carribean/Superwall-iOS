...
class SWWebView: WKWebView {
    ...
    weak var delegate: (SWWebViewDelegate & PaywallMessageHandlerDelegate)? {
        didSet {
            loadingHandler.webViewDelegate = delegate
        }
    }
    ...
    init(
        ...
        loadingHandler = SWWebViewLoadingHandler(enableMultiplePaywallUrls: featureFlags?.enableMultiplePaywallUrls == true)
        ...
        loadingHandler.loadingDelegate = self
