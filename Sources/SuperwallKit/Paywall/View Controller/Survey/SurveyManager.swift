...
final class SurveyManager {
    private static var otherAlertController: UIAlertController?
    ...
    private static func selectedOption(
    ...
    @objc
    private static func alertTextFieldDidChange(_ sender: UITextField) {
