...
public class PaywallViewController: UIViewController, LoadingDelegate {
    ...
    private lazy var refreshPaywallButton: UIButton = ButtonFactory.make(
    ...
    private lazy var exitButton: UIButton = ButtonFactory.make(
    ...
    init(
        ...
        cacheKey = PaywallCacheLogic.key(
    ...
    private nonisolated func trackOpen() async {
        await MainActor.run {
            lastOpen = Date()
        }
    ...
    private nonisolated func trackClose() async {
        await MainActor.run {
            lastOpen = nil
        }
    ...
    func loadWebView() {
        ...
        if let paywallArchiveManager = paywallArchiveManager,
    ...
    func set(
        ...
        paywallStateSubject = paywallStatePublisher
