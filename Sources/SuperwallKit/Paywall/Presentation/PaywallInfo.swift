...
public final class PaywallInfo: NSObject {
    ...
    init(
        ...
        self.url = url
        presentedByPlacementWithName = placementData?.name
        presentedByPlacementAt = placementData?.createdAt.isoString
        presentedByPlacementWithId = placementData?.id.lowercased()
        ...
        {
            responseLoadDuration = endTime.timeIntervalSince1970 - startTime.timeIntervalSince1970
        } else {
            responseLoadDuration = nil
        }
        ...
        {
            webViewLoadDuration = endTime.timeIntervalSince1970 - startTime.timeIntervalSince1970
        } else {
            webViewLoadDuration = nil
        }
        ...
        {
            productsLoadDuration = endTime.timeIntervalSince1970 - startTime.timeIntervalSince1970
        } else {
            productsLoadDuration = nil
        }
